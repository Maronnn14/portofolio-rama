...
async function sha256(message) {
  // Use native crypto if available (HTTPS or localhost)
  ...
  // Fallback for non-secure contexts (e.g. Laragon .test domains over HTTP)
  return _sha256Fallback(message);
}

// Pure JS SHA-256 fallback
function _sha256Fallback(ascii) {
  ...
  var hash = _sha256Fallback.h = _sha256Fallback.h || [];
  var k = _sha256Fallback.k = _sha256Fallback.k || [];
